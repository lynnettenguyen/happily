...
class ProductForm(FlaskForm):
   ...
   price = DecimalField('price', validators=[DataRequired(), validate_decimal, NumberRange(min=0.99, max=1000000, message='Price must be between $1.00 and $1,000,000')], places=2)
