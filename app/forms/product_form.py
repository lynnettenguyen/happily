...
class ProductForm(FlaskForm):
   name = StringField('name', validators=[DataRequired(), Length(min=10, max=225, message='Name must be between 10 and 255 characters long')])
   ...
   description = StringField('description', validators=[DataRequired(), Length(min=10, max=1000, message='Description must be between 10 and 2000 characters long')])
