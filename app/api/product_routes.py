...
@products.route("/<int:server_id>", methods=['PUT'])
@login_required
...
@products.route("/<int:server_id>", methods=['DELETE'])
@login_required
# delete server by id
...
@products.route("/<int:server_id>/channels")
@login_required
...
@products.route("/<int:server_id>/channels", methods=['POST'])
@login_required
...
@products.route("/<int:server_id>/channels/<int:channel_id>", methods=['PUT'])
@login_required
...
@products.route("/<int:server_id>/channels/<int:channel_id>", methods=['DELETE'])
@login_required
