...
def seed_images():
    ...
    Image(
        user_id=8, product_id=111, url='https://knotsy.s3.us-west-1.amazonaws.com/p111.1.webp'),
    Image(
        user_id=8, product_id=111, url='https://knotsy.s3.us-west-1.amazonaws.com/p111.2.webp')
    ]
