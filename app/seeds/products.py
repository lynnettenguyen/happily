...
def seed_products():
    ...
    Product(
        seller_id=1, category='Welcome Sign', name='Wedding Sign, Wedding Welcome Sign, Welcome Wedding Sign Wood, Wedding Decor, Wedding Signage, Welcome Sign Wedding, Welcome to our Wedding', price=55.00, description='This beautiful wood Wedding Sign is an eye-catcher for your guests to see as they enter your wedding venue! The Wedding Welcome Sign is great to use as special wedding decor and can double as home decor after the wedding festivities end. Our customers love to give these custom signs as wedding gifts, engagement gifts, and anniversary gifts as well since they make great gifts for couples. Your sign will be personalized with 3-D lettering (laser cut) to welcome your guests to your special day.'),
    Product(
        seller_id=2, category='Welcome Sign', name='Frosted Acrylic Wedding Welcome Sign ,Acrylic Welcome Sign, Wedding Signage, Acrylic Wedding Sign, 3D Welcome Sign, Custom Wedding Sign', price=87.99, description='We have always believed that “Weddings do not have to be expensive, it has to be memorable”, so in order to make it memorable we are determined to add all the love, creativity and customized touch to the Welcome Signs. Customized Welcome signs are a beautiful Wedding décor to welcome your guest.'),
    Product(
        seller_id=1, category='Welcome Sign', name='3D Wooden Welcome to our Wedding Sign, Wedding Signage, Wedding Welcome Sign, Rustic Wedding Decor, Welcome Wedding Rosefield', price=110.00, description='Our unique 3D wooden wedding welcome signs come personalized with your names and wedding date. This sign is a beautiful statement piece for your wedding ceremony and will add a perfect touch to your special day. Raised lettering creates a rather unique 3D effect that adds depth and character to the piece.'),
    Product(
        seller_id=2, category='Welcome Sign', name='Frosted Acrylic Wedding Welcome Sign - Wedding Signage - Modern Wedding Sign - Acrylic Welcome Wedding Sign - Wedding Ceremony Signs', price=152.91, description='Our frosted acrylic wedding welcome sign is a great way to welcome in your guests at your wedding or any of your special events.'),
    Product(
        seller_id=2, category='Welcome Sign', name='Acrylic Wedding Sign - Wedding Welcome Sign - Welcome to our Wedding Sign', price=18.00, description='This acrylic sign has a glass-like elegance without the risk of breakage. Enhance your event with a beautiful eye catching sign. Our designs our 100% permanent (not vinyl) and won\'t scratch or fade. Acrylic is shatterproof and lightweight to make for a crisp, clean look. These can be placed in an easel or a frame'),
    Product(
        seller_id=1, category='Welcome Sign', name='Wedding Welcome Sign, Wedding Sign, Welcome To Our Wedding Sign, Wedding Sign Board, Wedding Signs, Wedding Vertical Modern Outdoor Sign', price=57.07, description='This wedding sign is expertly handcrafted just for you.'),
    Product(
        seller_id=3, category='Welcome Sign', name='Wedding Welcome Sign Watercolor, Unique Wedding Decor from Couple Portrait, Photo Wedding Sign, Unique Wedding Decoration, Wedding Entrance', price=35.40, description='" WOW! " your loved ones with this unique wedding entrance sign, a timeless and meaningful painting. We turn your photo into stunning work of art and treasure your favorite memories for years to come! It is the perfect wedding welcome sign with a watercolor touch, that you can keep it forever to remember your wedding day. Your guests can even sign on it and that makes a unique wedding guest book alternative :)'),
    Product(
        seller_id=2, category='Welcome Sign', name='Acrylic Last Name Wedding Sign, Wedding Welcome Sign, Wooden Frame, Clear Wedding Sign, Personalized Wedding Sign', price=85.00, description='This acrylic last name wedding sign is a great way to welcome guests to your big day, and then repurpose as home decor after!'),
    Product(
        seller_id=1, category='Welcome Sign', name='3D Acrylic Wedding Welcome Sign | Frosted acrylic wedding sign | Welcome to our wedding sign | Modern wedding signage | Ceremony Sign', price=168.67, description='Modern and eye catching, this sign is the perfect way to greet your guests on the big day.'),
    Product(
        seller_id=3, category='Welcome Sign', name='Wedding welcome sign wood, Wedding Reception Sign, Rustic Wedding welcome sign, Welcome Wedding Sign, Personalized Wedding gift', price=59.67, description='Our wooden welcome signs for a wedding are a beautiful way to welcome guests as they arrive at your wedding! It adds a lovely personal touch and is a timeless keepsake. Works great as a wedding gift to the Bride & Groom as well!'),
    Product(
    ...
    Product(
        seller_id=1, category='Arch', name='Double Square Wedding Arch Bridal Shower Ceremony Flower Arch Balloons Arch Background Party Stage Rustic Wedding Decoration', price=385.00, description='Double Pole Square Wedding Arch Wrought Iron Frame Background Party Stage Flower Arch Decoration'),
    Product(
        seller_id=2, category='Arch', name='Handmade Macrame Wedding Backdrop, Macrame Wedding Arch Arbor, Macrame Wall Hanging,Macrame Door Hanging,Room Divider,Macrame Curtains', price=44.99, description='Create your dream boho living space with our cotton macrame wallhangings.'),
    Product(
        seller_id=1, category='Arch', name='Wedding Backdrop | Wedding Arch Alternative | Floral Stands | Ceremony Floral Accents | Decor | Custom Sizes Available', price=270.00, description='These handmade COPPER STANDS are perfect for shaping your alter with your custom wedding color florals. These pieces come polished and cleaned thoroughly however copper naturally holds onto oils so I highly recommend using TarnX to polish the copper a day or two before your event to make it the most beautiful rose gold color.'),
    Product(
        seller_id=4, category='Arch', name='Wedding Arch, Wedding Decor, Ceremony Arch, Wedding Arbor, Rustic Wedding Arch, Wedding Arch Hexagon, Beach Wedding, Boho Decor', price=188.09, description='Our Personalized Wedding Arch is the best choice for your special day, which will decorate your holiday and make your ceremony look perfect.'),
    Product(
        seller_id=3, category='Arch', name='Customized Arch Extra Stable 7.87ft Metal Double Ring Round Hoop Circle Wedding Floral Wheel Bridal Door Backdrop Stand For Boho Wedding', price=215.00, description='This Handmade Customized 7 ft Metal Double Ring Round Circle Wedding Wreath Floral Arch Wheel Backdrop is stunning for your wedding vows, wedding photos, social media photo booster, and so many possibilities!'),
    Product(
        seller_id=2, category='Arch', name='Wedding Arch - Hexagon Wedding Arch - Wooden Arch Wedding - Boho Wedding Décor - Geometric Wedding Arbor - Rustic Wedding Backdrop', price=209.66, description='This wedding arch will be the centerpiece décor on your Big day. So it has to be perfect. We wanted to create something we would be proud to use at our own wedding.'),
    Product(
        seller_id=1, category='Bar', name='Signature Dog Cocktails Frosted Acrylic Wedding Bar Sign || custom wedding bar sign personalized bar drinks menu after party 03-038-547', price=18.36, description='Our acrylic signs are a beautiful way to welcome your guests. Made on sturdy acrylic for a glass-like effect, they are eye-catching and stunning. Our signs are never made using vinyl or stickers, and the design is 100% permanent. It will never fade or scratch off and is 100% weatherproof. Acrylic is a a superior material for signs, it is shatterproof, rigid enough to stand on its own while being lightweight and easy to handle. Place it in an easel for a crisp, clean look, frame it, or dress up with a floral arrangement.'),
    Product(
        seller_id=3, category='Bar', name='Signature Cocktails Acrylic Sign, Signature Drink Bar Menu, Wedding Bar Menu, Wedding Bar Sign, Acrylic Bar Menu Sign', price=25.00, description='This is a perfect signature drink sign for a wedding or party.'),
    Product(
        seller_id=3, category='Bar', name='Acrylic Bar Menu | Arch bar menu | Custom drinks menu | Bar menu | Wedding menu | Wedding decor | Drinks list | Wedding | Engagement', price=18.11, description='Our personalized bar/drinks menu adds the perfect personalized touch to your wedding, engagement, or event.'),
    Product(
        seller_id=4, category='Bar', name='Signature Drinks Sign Template | Minimalist Wedding Bar Menu Poster | Signature Cocktail Sign | His + Hers Bar Sign | Editable Template | M9', price=7.79, description='This editable Signature Drink Sign features modern minimalist fonts where you have the freedom to create your personalized specialty cocktails! Easily change the fonts, font colors, and background color to match your unique style! After you place your order, you will receive an email from Templett with access to your self-editable template where you will be able to customize all your own details! '),
    Product(
        seller_id=4, category='Bar', name='Acrylic Wedding Bar Sign | Signature Drink 8x10 Frosted Bar Menu | Open Bar Sign | Modern Wedding Sign | Event Stationery | His Hers Drinks', price=60.24, description='This bar sign is perfect for your modern wedding or event.'),
    Product(
        seller_id=4, category='Bar', name='Acrylic Split Arch Wedding Bar Sign | Signature Drink 8x10 Frosted Bar Menu | Open Bar Sign | Modern Wedding Sign | His Hers Drinks', price=71.49, description='This bar sign is perfect for your modern wedding or event.'),
    Product(
        seller_id=1, category='Bar', name='Bar Menu Template, Modern Editable Drink Menu Template, Minimalist Printable Bar Menu, Signature Drinks Sign, 1,300+ Drink Images, Greenery', price=5.59, description='Print your own Signature Drink Sign with this template.'),
    Product(
        seller_id=3, category='Bar', name='Juliette Furbabies Signature Cocktails Sign, Cats and Dogs, Bar Menu, Bar Sign, Drinks Sign, Printable Editable Template #004', price=6.00, description='A wonderful way to include your furbabies on your special day. Edit the design with your words to make it your own and print!'),
    Product(
        seller_id=3, category='Bar', name='Wedding Signature Drink Dogs, Watercolor Wedding Sign Pets, Dog Bar Menu Signs, Signature Cocktail Drinks with Cats, Elegant Wedding Signs', price=59.42, description='Custom Wedding Signature Drinks Sign with Dogs and Cats create from photos. MAKE YOUR BELOVED FURRY BABIES A PART OF YOUR SPECIAL DAY!p40.'),
    Product(
        seller_id=4, category='Welcome Sign', name='Wedding Order of Events Sign Printable, Dogs Wedding Timeline Sign, Wedding Welcome Sign with Pets, Personalized Wedding Signs, Boho Wedding', price=36.29, description='Personalized Wedding Order of Events Sign with Multiple Icon Options to create your own personalized Wedding Sign. You can also include your dear furry friends into the sign, which is an adorable way to honor your pets to your wedding day! 300 dpi high resolution ready-to-print PDF & JPG files for you to print.'),
    Product(
    ...
    Product(
        seller_id=5, category='Bar', name='Bar Menu Signature Cocktails Custom Clear Glass Look Acrylic Wedding Sign With Stand, His Her Drinks Lucite Perspex Bar Table Sign', price=31.99, description='Bar Menu Signature Cocktails Custom Clear Glass Look Acrylic Wedding Sign With Stand, His Her Drinks Lucite Perspex Bar Table Sign'),
    Product(
        seller_id=4, category='Bar', name='Open Bar Sign - Acrylic Wedding Sign - Wedding Open Bar Sign - Tomorrow\'s Stories are Priceless', price=15.99, description='Let your guests know the party is ready to begin with our "Open Bar" Sign!'),
    Product(
    ...
    Product(
        seller_id=1, category='Welcome Sign', name='Wedding Welcome Sign - Modern Wedding Sign - Acrylic Wedding Sign - Lucite Wedding Sign - Wedding Signs - Acrylic - Acrylic Wedding WEL012-c', price=31.45, description='Custom acrylic welcome sign made out of 1/8" acrylic, not glass.'),
    Product(
