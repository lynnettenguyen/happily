...
def seed_shops():
    demo_shops = [
      ...
      Shop(user_id=4, title='Uniquely handcrafted wedding decor and accessories', location=' Sunnyvale, California', icon='https://knotsy.s3.us-west-1.amazonaws.com/demo_icon.png'),
